...
import { getVideoMedia, getAudioMedia, stopVideo, stopAudio } from 'lib/helper'
...
const PreviewWebcam = () => {
    ...
    return (
        <Draggable>
            <div className='absolute left-1/2 bottom-20 z-10 w-64 h-64 -ml-32 flex flex-col items-center justify-center bg-white rounded-full cursor-move shadow-lg'>
                {videoOn
