...
import { getViewportSize, keyPressArrowOrWASD, pressKeyMapping } from './helper'
...
export class Scene extends Phaser.Scene {
    ...
    _createPlayer(id, x, y, playerName, avatarUrl) {
        this.load.once('complete', () => {
            ...
            graphics.lineStyle(10, 0x2fecca)
            ...
            const name = this.add
                .text(20, 23, playerName, { fontFamily: 'Arial', color: '#fff' })
                .setFontSize(14)

            graphics.fillStyle(0x2fecca)
            graphics.fillRoundedRect(15, 20, name.width + 10, name.height + 6, 3)
